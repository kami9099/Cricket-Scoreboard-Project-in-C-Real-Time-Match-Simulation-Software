...
class Team
{
   ...
   Team()
   {
       ...
       on_strike_batsman = 0;
       far_end_batsman=1;
       on_strike_bowler=0;// set ffall_of_wickets[10][2]irst player as default bowler , later to give
   ...
   */
   ...
   int on_strike_bowler;
   */
   cout << "Batsmen on Strike "
<<battingTeam.p[battingTeam.on_strike_batsman].name_of_player << '\n';
   cout << "Strike Rate "<<
battingTeam.p[battingTeam.on_strike_batsman].strike_rate_of_a_player << "\n\n";
   cout << "Batsmen far End "
<<battingTeam.p[battingTeam.far_end_batsman].name_of_player << '\n';
   cout << "Strike Rate "<<
battingTeam.p[battingTeam.far_end_batsman].strike_rate_of_a_player << "\n\n";
   cout << "Previous Bowler "
<<bowlingTeam.p[bowlingTeam.on_strike_bowler].name_of_player << "\n";
   cout << "Economy Rate "
<<bowlingTeam.p[bowlingTeam.on_strike_bowler].economy_rate_of_a_player << "\n\n";
   // Previous over runns
   }
   ...
   displayChowkaChakkaWicket(result);
               ...
               //no_of_wicket_taken=0 if input is 'w' then update the wickets taken in the
               if (result=='w' || result == 'W')
               {
                   ...
                   battingTeam->on_strike_batsman = (battingTeam->on_strike_batsman >
battingTeam->far_end_batsman ) ? battingTeam->on_strike_batsman + 1 : battingTeam->far_end_batsman + 1;
               }
   ...
   */
   ...
   battingTeam->on_strike_batsman=battingTeam->on_strike_batsman-battingTeam->far_end_batsman;
               ...
               if (i % 6 == 0 )
               {
                   ...
                   bowlingTeam->p[bowlingTeam->on_strike_bowler].over_played++;//update the balldelivered
...
battingTeam->p[battingTeam->far_end_batsman].strike_rate_of_a_player=(battingTeam->p[battingTeam->far_end_batsman].no_of_runs_scored / (battingTeam->p[battingTeam->far_end_batsman].no_of_balls_played ))*100;
                   ...
                   bowlingTeam->p[bowlingTeam->on_strike_bowler].economy_rate_of_a_player=
(bowlingTeam->p[bowlingTeam->on_strike_bowler].no_of_runs_given*1.0/bowlingTeam->p[bowlingTeam->on_strike_bowler].no_of_balls_delivered)*100;
...
int main()
{
   ...
   //After innnings is over we hv to displa
